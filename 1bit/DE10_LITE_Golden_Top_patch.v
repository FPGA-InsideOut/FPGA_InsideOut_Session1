//!!!IMPORTANT!!! - IMPLEMENTATION OF THIS CODE ON FPGA MAY POTENTIALLY RESULT IN BOARD DAMAGE. PROCEED AT YOUR OWN RISK.
//
...
//Instantiate CRC1BIT module
crc1bit CRC1BIT1(.data_in(SW[6]), .crc_en(SW[8]), .lfsr_c({LEDR[0],LEDR[1],LEDR[2],LEDR[3],LEDR[4],LEDR[5]}), .rst(SW[9]), .clk(KEY[0]));
